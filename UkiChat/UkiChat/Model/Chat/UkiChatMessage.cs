...
public record UkiChatMessage(ChatPlatform Platform, List<string> Badges, string DisplayName, string Message)
{
    public static UkiChatMessage FromTwitchMessage(ChatMessage twitchMessage)
    {
        return new UkiChatMessage( ChatPlatform.Twitch, [], twitchMessage.DisplayName, twitchMessage.Message);
    }
